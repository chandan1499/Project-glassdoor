                    ...
                    <div className={styles.otherLinks}>
                        <div className={styles.flex}>
                            ...
                            <div className={styles.link} onMouseOver={() => { setCompaninesPopupStyle("block") }} onMouseOut={() => { setCompaninesPopupStyle("none") }}>
                                ...
                                <div className={styles.link} onMouseOver={() => { setSalariesPopupStyle("block") }} onMouseOut={() => { setSalariesPopupStyle("none") }}>
                            ...
                            <div className={styles.link} onMouseOver={() => { setInterviewsPopupStyle("block") }} onMouseOut={() => { setInterviewsPopupStyle("none") }}>
