              ...
              <div>
                ...
                <div className={styles.profile_body}>
                  <ul>
                    ...
                    <li>
                      <span className={styles.spans}>
                      <svg class="SVGInline-svg" className={styles.svgs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><g fill="none" fill-rule="evenodd"><path d="M28 16.1c-2-1.3-4.4-2.1-7-2.1-7.2 0-13 5.8-13 13s5.8 13 13 13 13-5.8 13-13c0-1.273-.192-2.499-.54-3.653a12.93 12.93 0 00-1.083-2.553" fill="#FFF"></path><path d="M28 16.1c-2-1.3-4.4-2.1-7-2.1-7.2 0-13 5.8-13 13s5.8 13 13 13 13-5.8 13-13c0-1.273-.192-2.499-.54-3.653a12.93 12.93 0 00-1.083-2.553" stroke="#0CAA41" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M21 34.429a7.429 7.429 0 110-14.858 7.429 7.429 0 010 14.858zM21 30a3 3 0 100-6 3 3 0 000 6z" fill="#DFF7E7"></path><path d="M24.157 20.221c-.928-.464-2.043-.65-3.157-.65-4.086 0-7.429 3.343-7.429 7.429s3.343 7.429 7.429 7.429 7.429-3.343 7.429-7.429c0-.555-.07-1.086-.185-1.607a10.35 10.35 0 00-.207-.782m7.213-11.362L21.75 26.75" stroke="#0CAA41" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M31.87 10.23l5.19-4.953c.636-.608 1.69-.157 1.69.723v3.25a.5.5 0 00.5.5h3.25c.902 0 1.343 1.1.691 1.723l-5.46 5.222a2 2 0 01-1.382.555h-4.093a1 1 0 01-1-.999l-.005-4.571a2 2 0 01.619-1.45z" fill="#0CAA41" fill-rule="nonzero"></path></g></svg>
                      </span>
                      <p>Personalised search results</p>
                    </li>
                    <li>
                    <span className={styles.spans}>
                    <svg class="SVGInline-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><g fill="none" fill-rule="evenodd"><path fill="#FFF" stroke="#0CAA41" stroke-linejoin="round" stroke-width="2" d="M10 39V9h26v30z"></path><circle cx="18" cy="17" r="5" fill="#DFF7E7"></circle><path fill="#0CAA41" d="M18 18.667a1.667 1.667 0 110-3.334 1.667 1.667 0 010 3.334zm-3.144 2.221a3.335 3.335 0 016.288 0A4.98 4.98 0 0118 22a4.98 4.98 0 01-3.144-1.112z"></path><path stroke="#0CAA41" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M25.35 14h6.3m-6.317 4h6.317M14.7 25.5h12.6m-12.633 4H22m-7.3 4h12.6"></path><g stroke-width="2"><circle cx="32.5" cy="30.5" r="7.5" fill="#DFF7E7" stroke="#0CAA41" stroke-linejoin="square"></circle><circle cx="32.5" cy="30.5" r="9.5" stroke="#FFF"></circle></g><path stroke="#0CAA41" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M38.5 36.5l3.482 3.482"></path></g></svg>
                    </span>
